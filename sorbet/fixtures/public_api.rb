...
create_request = T.let(
  Inttegro::Order::CreateExistingCustomer.new(customer_id: "cu_example", line_items: []),
  Inttegro::Order::CreateExistingCustomer
)
created_order = T.let(client.orders.create(create_request), Inttegro::Order)
T.assert_type!(created_order.id, String)
T.assert_type!(client.customers.page, Inttegro::Customer::Page)
T.assert_type!(client.payment_methods.settings, Inttegro::PaymentMethod::Settings)
T.assert_type!(
  client.payment_methods.deactivate(payment_method_id: "pm_example"),
  Inttegro::PaymentMethod
)
T.assert_type!(client.payouts.enable, Inttegro::Payout::SettingsMutation)
T.assert_type!(client.otp.initialize_session({}), Inttegro::OTP::Transaction)
...
T.assert_type!(Inttegro::Product::Type::DIGITAL, Inttegro::Product::Type)
