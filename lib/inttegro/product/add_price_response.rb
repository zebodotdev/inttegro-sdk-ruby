...
module Inttegro
  class Product
    # Typed representation of the add price response object in the Inttegro API.
    #
    ...
    #   @return [Inttegro::Price::CatalogPrice, nil]
    #
    # @!attribute [r] error
    ...
    class AddPriceResponse < T::Struct
      const :price, T.nilable(Inttegro::Price::CatalogPrice), default: nil
