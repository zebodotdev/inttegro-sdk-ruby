...
module Inttegro
  class File
    # Typed representation of the service ready response object in the Inttegro API.
    #
    ...
    #   @return [String]
    #
    # @!attribute [r] files_base_url
    #   Value of the `files_base_url` field in the Inttegro API payload.
    #
    #   Required in the API payload. Wire name: `files_base_url`.
    #   @return [String]
    #
    ...
    #   @return [Time]
    class ServiceReadyResponse < T::Struct
