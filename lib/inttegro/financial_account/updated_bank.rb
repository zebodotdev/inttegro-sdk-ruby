...
module Inttegro
  class FinancialAccount
    # Typed representation of the updated bank object in the Inttegro API.
    #
    ...
    #   @return [Inttegro::BankAccount::Updated, nil]
    class UpdatedBank < T::Struct
      const :id, String
      const :type, Inttegro::BankAccount::Type
      const :ghana_bank_account, T.nilable(Inttegro::BankAccount::Updated), default: nil
    end
  end
end
