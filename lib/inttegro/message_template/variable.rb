...
require_relative "variable_item"
require_relative "variable_type"

module Inttegro
  class MessageTemplate
    # Typed representation of the variable object in the Inttegro API.
    #
    ...
    #
    # @!attribute [r] items
    #   Value of the `items` field in the Inttegro API payload.
    #
    #   Optional in the API payload; omitted values default to `nil`. Wire name: `items`.
    #   @return [Array<Inttegro::MessageTemplate::VariableItem>, nil]
    #
    # @!attribute [r] name
    ...
    #
    #   Required in the API payload. Wire name: `required`.
    #   @return [Boolean]
    #
    # @!attribute [r] type
    ...
    class Variable < T::Struct
      const :about, T.nilable(String), default: nil
      const :default, T.nilable(Object), default: nil
      const :items, T.nilable(T::Array[Inttegro::MessageTemplate::VariableItem]), default: nil
      const :name, String
