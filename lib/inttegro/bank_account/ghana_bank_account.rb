...
module Inttegro
  module BankAccount
    # Typed representation of the ghana bank account object in the Inttegro API.
    #
    ...
    #   @return [Inttegro::FinancialAccount::Owner]
    #
    # @!attribute [r] name
    ...
    class GhanaBankAccount < T::Struct
      ...
      const :holder, Inttegro::FinancialAccount::Owner
