...
module Inttegro
  module Schedule
    # Typed representation of the creation detail object in the Inttegro API.
    #
    ...
    #
    #   Optional in the API payload; omitted values default to `nil`. Wire name: `recipients`.
    #   @return [Array<String>, nil]
    #
