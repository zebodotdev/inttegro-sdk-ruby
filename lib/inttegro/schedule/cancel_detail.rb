...
module Inttegro
  module Schedule
    # Typed representation of the cancel detail object in the Inttegro API.
    #
    ...
    #   @return [Array<Inttegro::Schedule::Error>, nil]
    #
    ...
    class CancelDetail < T::Struct
      ...
      const :errors, T.nilable(T::Array[Inttegro::Schedule::Error]), default: nil
