...
module Inttegro
  class UploadRequest
    # Typed representation of the review attempt by ordinal request object in the Inttegro API.
    #
    ...
    # @api public
    #
    # @!attribute [r] attempt_ordinal
    #   Value of the `attempt_ordinal` field in the Inttegro API payload.
    #
    #   Required in the API payload. Wire name: `attempt_ordinal`.
    #   @return [Integer]
    #
    ...
    class ReviewAttemptByOrdinalRequest < T::Struct
