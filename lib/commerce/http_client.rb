...
module Commerce
  ...
  class HTTPClient
    ...
    USER_AGENT = T.let("zebo-commerce-sdk-ruby/#{Commerce::VERSION}", String)
    ...
    def wrap_response(data, model_class = nil)
      ...
      when Hash
        ...
        model_class ? Commerce::Models.deserialize(payload, model_class) : ResponseObject.new(payload)
      when Array
    ...
    def response_model_for(path)
      return Commerce::Models::CancelOTPResponse if path == "/otp/cancel"
      return Commerce::Models::OrderResponse if path == "/orders/new"

      Commerce::Operations::RESPONSE_MODELS[path]
    end
