...
module Commerce
  module Resources
    ...
    class Payouts
      ...
      #
      # @see https://commerce.zebo.dev/enable-automatic-payouts for configuration guide
      ...
      #
      # @see https://commerce.zebo.dev/product-payouts for payouts overview
      def settings
      ...
      #
      # @see https://commerce.zebo.dev/disable-fx-payouts for FX payout guide
      def disable_fx
